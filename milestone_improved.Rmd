...
setwd("C:\\Program Files (x86)\\GnuWin32\\bin")

lines <- system("wc -l C:\\Users\\Dimitris\\Documents\\coursera\\capstone\\project\\Coursera-SwiftKey\\final\\en_US\\*.txt", intern=TRUE)
words <- system("wc -w C:\\Users\\Dimitris\\Documents\\coursera\\capstone\\project\\Coursera-SwiftKey\\final\\en_US\\*.txt", intern=TRUE)
longest <- system("wc -L C:\\Users\\Dimitris\\Documents\\coursera\\capstone\\project\\Coursera-SwiftKey\\final\\en_US\\*.txt", intern=TRUE)
...
lines <- system("wc -l C:\\Users\\Dimitris\\Documents\\coursera\\capstone\\project\\Coursera-SwiftKey\\final\\en_US\\sample\\*.txt", intern=TRUE)
words <- system("wc -w C:\\Users\\Dimitris\\Documents\\coursera\\capstone\\project\\Coursera-SwiftKey\\final\\en_US\\sample\\*.txt", intern=TRUE)
longest <- system("wc -L C:\\Users\\Dimitris\\Documents\\coursera\\capstone\\project\\Coursera-SwiftKey\\final\\en_US\\sample\\*.txt", intern=TRUE)
